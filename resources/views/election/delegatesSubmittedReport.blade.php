...
$(document).ready(function() {
    ...
    var currentRoute = "{{ Route::currentRouteName() }}";
        if (currentRoute === 'delegates-submitted-report') {
            $('#delTable').DataTable().column(4).visible(false);
            $('#delTable').DataTable().column(5).visible(false);
            $('#altTable').DataTable().column(4).visible(false);
            $('#altTable').DataTable().column(5).visible(false);
        }
